 ...
 * @author tjkendon
 */
public class AverageTimeAggregatorTest {
   ...
   static PlaySessionList sourceData;
    ...
    public AverageTimeAggregatorTest() {
    ...
    public void testAggregateEmptyPlayData() {
        ...
        AverageTimeAggregator instance = new AverageTimeAggregator(source);
    ...
    public void testAggregatePlayDataOneGame() {
        ...
        expResult.putAggregate(f, PlayAggregate.AggregateType.AVERAGE_TIME, 0.6 / 6);
    ...
    public void testAggregatePlayDataMultiGame() {
        ...
        AverageTimeAggregator instance = new AverageTimeAggregator(sourceData);
        
        PlayAggregate expResult = new PlayAggregate();
        
        expResult.putAggregate(
                a, PlayAggregate.AggregateType.AVERAGE_TIME, 1.0 / 1.0);
        expResult.putAggregate(
                b1, PlayAggregate.AggregateType.AVERAGE_TIME, 2.0  / 4.0);
        expResult.putAggregate(
                b2, PlayAggregate.AggregateType.AVERAGE_TIME, 1.0 / 2.0);
        expResult.putAggregate(
                b3, PlayAggregate.AggregateType.AVERAGE_TIME, 1.5 / 2.0);
        expResult.putAggregate(
                c1, PlayAggregate.AggregateType.AVERAGE_TIME, 3.5 / 5.0);
        expResult.putAggregate(
                c2, PlayAggregate.AggregateType.AVERAGE_TIME, 4.25 / 2.0);
        expResult.putAggregate(
                c3, PlayAggregate.AggregateType.AVERAGE_TIME, 0.5 / 1);
        //expResult.putAggregate(
        //        d, PlayAggregate.AggregateType.AVERAGE_TIME, 0);
        expResult.putAggregate(
                e, PlayAggregate.AggregateType.AVERAGE_TIME, 10.75 / 13);
        expResult.putAggregate(
                f, PlayAggregate.AggregateType.AVERAGE_TIME, 0.6 / 6);
        expResult.putAggregate(
                g, PlayAggregate.AggregateType.AVERAGE_TIME, 1.5 / 1);
